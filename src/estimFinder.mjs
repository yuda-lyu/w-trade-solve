 ...
 * name、symbol、interval、fdOhlc、fdParam與fdData無效時throw
 *
 ...
 *
 */
let estimFinder = async (ott, name, symbol, interval, fdOhlc, fdParam, fdData, opt = {}) => {
    ...
    //estimComps
    await estimComps(ott, name, symbol, interval, fdOhlc, fdParam, timeStart, timeEnd, mode, comps, fdData, opt)
